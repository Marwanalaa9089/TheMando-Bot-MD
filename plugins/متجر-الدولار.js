...
> ˼⚡˹↜ الاســعــار ↶
╮───────────────────⟢ـ
┆˼بريميام-مؤقت🍷˹┆⌊ 100 الف ⌉
┆˼بريميام-دائم🍷˹┆⌊ 500 الف ⌉
┆˼تحويل🍷˹┆⌊ ضريبة 500 ⌉
┆˼منع استخدام البوت🍷˹┆⌊ 300 الف ⌉
╯───────────────────⟢ـ
...
> © 𝐍𝐀𝐑𝐔𝐓𝐎 & 𝐙𝐀𝐂𝐊 2025`,
                    ...
                    nativeFlowMessage: {
                        buttons: [
                            {
                                name: "quick_reply",
                                buttonParamsJson: '{"display_text":"⌈🏷╎مـتـجـر الـذهـب╎🏷⌋","id":".متجر2"}'
                            },
                            {
                                name: "cta_url",
...
handler.help = ['info'];
handler.tags = ['main'];
handler.command = ['المتجر1', 'متجر_دولار', 'متجر_الدولار', 'متجر1'];
